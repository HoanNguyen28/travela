    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-3 col-md-6 col-sm-10 rmb-75">
                ...
                <a href="{{ route('tours') }}" class="clear_filter">Clear</a>
                </div>
                    ...
                    <div class="widget widget-activity" data-aos="fade-up" data-aos-duration="1500"
                        ...
                        <ul class="radio-filter">
                            ...
                            <li>
                                 <input class="form-check-input" type="radio"name="domain" 
                                id="id_mien_nam" value="n">
                                <label for="id_mien_nam">Miền Nam<span>{{$domainsCount['mien_nam'] }}</span></label></li>                  
                        </ul>
                    </div>
