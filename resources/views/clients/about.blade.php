                            ...
                            <div class="row">
                                <div class="col-lg-8 pe-lg-5 me-lg-5">
                                    <div class="section-title mb-25">
                                        <h2>Kinh nghiệm và công ty lữ hành chuyên nghiệp trên Việt Nam</h2>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                ...
                                <div class="col-md-8">
                                    <p>Chúng tôi chuyên mang đến những trải nghiệm thành phố khó quên dành cho du khách muốn khám phá 
                                        trái tim và linh hồn của các đô thị. Các tour du lịch được hướng dẫn bởi đội ngũ 
                                        chuyên nghiệp của chúng tôi sẽ đưa bạn dạo bước qua những con phố sôi động, các địa
                                         danh lịch sử và cả những viên ngọc ẩn giấu của mỗi thành phố.</p>
                    ...
                    <div class="col-xl-4 col-md-8">
                        <div class="about-feature-boxes" data-aos="fade-up" data-aos-delay="100" data-aos-duration="1500" data-aos-offset="50">
                            <div class="feature-item style-three bgc-secondary">
                                ...
                                <div class="content">
                                    <p>tại Pinnacle Business Solutions cam kết về sự đổi mới đã đạt được</p>
                                </div>
                            </div>
                            <div class="feature-item style-three bgc-primary">
                                ...
                                <div class="content">
                                    <p>Đội ngũ chuyên gia của chúng tôi luôn tận tâm phát triển những chiến lược tiên tiến nhằm thúc đẩy thành công.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row align-items-center">
                    <div class="col-xl-5 col-lg-6">
                        <div class="about-us-content rmb-55" data-aos="fade-left" data-aos-duration="1500" data-aos-offset="50">
                            ...
                            <p>Chúng tôi hợp tác chặt chẽ với khách hàng để thấu hiểu những thách thức và mục tiêu, 
                                từ đó cung cấp các giải pháp tùy chỉnh nhằm nâng cao hiệu quả, 
                                gia tăng lợi nhuận và thúc đẩy tăng trưởng bền vững.</p>
                            <div class="row pt-25">
                                <div class="col-6">
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="team-item hover-content" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">
                            <img src="{{ asset('clients/assets/images/team/Hoan-Nguyen.jpg')}}" alt="Guide">
                            <div class="content">
                                <h6>Nguyen Van Hoan Nguyen</h6>
                                <span class="designation">Co-founder</span>
                                <div class="social-style-one inner-content">
                                    <a href="contact.html"><i class="fab fa-twitter"></i></a>
                                  <a href="https://www.facebook.com/hoannguyen2809/"><i class="fab fa-facebook-f"></i></a>
        ...
        <section class="about-feature-two bgc-black pt-100 pb-45 rel z-1">
            <div class="container">
                <div class="section-title text-center text-white counter-text-wrap mb-50" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">
                    <h2>Làm thế nào để hưởng lợi ích từ các chuyến du lịch của chúng tôi</h2>
                ...
                <div class="row">
                    <div class="col-xl-3 col-lg-4 col-md-6" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">
                        <div class="feature-item style-two">
                            ...
                            <div class="content">
                                <h5><a href="{{route('tours')}}">Đảm bảo tốt nhất</a></h5>
                                <p>Cắm trại bằng lều là cách tuyệt vời nhất để kết nối với thiên nhiên</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="50" data-aos-duration="1500" data-aos-offset="50">
                        <div class="feature-item style-two">
                            ...
                            <div class="content">
                                ...
                                <p>Đạp xe leo núi là môn thể thảo để rèn luyện thể lực</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="150" data-aos-duration="1500" data-aos-offset="50">
                        <div class="feature-item style-two">
                            ...
                            <div class="content">
                                <h5><a href="{{route('tours')}}">Hướng dẫn viên du lịch tốt nhất</a></h5>
