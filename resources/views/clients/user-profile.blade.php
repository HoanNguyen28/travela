            ...
            <div class="col-xl-4">
                ...
                <div class="card mb-4 mb-xl-0">
                    ...
                    <div class="card-body text-center">
                        ...
                        <input type="hidden" name="-token" value="{{ csrf_token() }}" class="__token">
                  ...
                  <div class="card mb-4 mb-xl-0">
                    <button class="btn btn-primary"  id="update_passowrd_profile">Đổi mật khẩu</button>
                </div>
            </div>
            <div class="col-xl-8">
                <div class="card mb-4">
                        ...
                        <form action="{{ route('update-user-profile') }}" method="POST" name="updateUser"
                            ...
                            <div class="row gx-3 mb-3">
                                <div class="col-md-12">
                                    ...
                                    <input class="form-control" id="inputFullName" type="text" placeholder="Họ và tên"
